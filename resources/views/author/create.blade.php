...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <h1 class="text-3xl font-semibold text-primary mb-6">Add New Author</h1>
  ...
  <form action="{{ route('authors.store') }}" method="POST" class="bg-white shadow-md rounded-xl p-6 space-y-6">
    @csrf
